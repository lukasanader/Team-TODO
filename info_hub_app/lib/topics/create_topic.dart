...
class CreateTopicScreen extends StatefulWidget {
  ...
  static const String routeName = '/topic_form';
...
class _CreateTopicScreenState extends State<CreateTopicScreen> {
  ...
  bool _notAnimationOrEditScreen(Route<dynamic> route) {
    // Replace `AnimationScreen` and `TopicFormScreen` with your actual screen classes
    return !(route.settings.name == CreateTopicScreen.routeName);
  }
